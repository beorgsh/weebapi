...
async def get_full_data(siteLink: str):
    ...
    siteLink refers to the identifier following 'https://animepahe.si/anime/' """
...
async def get_download_options(episodeLink: str):
    ...
    episodeLink refers to the  complete 'https://animepahe.si/play/' link for the episode"""
